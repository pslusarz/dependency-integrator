...
class StringMajorMinorPatchVersionTest {
    ...
    void parseFromGitLogSimple() {
       ...
       List<Version> versionList = StringMajorMinorPatchVersion.parseFromGitLog(gitLog)
       assert 1 == versionList.size()
       assert versionList.first().toString() == "3.3.0"
    }
    ...
    void parseFromGitLogSnapshot() {
        ...
        List<Version> versionList = StringMajorMinorPatchVersion.parseFromGitLog(gitLog)
        assert versionList.first().toString() == "2.1.19"
    }
...
0e01c5828faf5d62a7af3d013deace363ea674de Tagging 3.2.0 for release"""
        ...
        assert versionList.first().toString() == "3.2.0"
        assert versionList.last().toString() == "3.3.0"
    }
...
064a01a79915622fc1188b9a530f34a9ed0abbe1 Tagging 2.3.0 for release"""
        List<Version> versionList = StringMajorMinorPatchVersion.parseFromGitLog(gitLog)
        assert 2 == versionList.size()
        assert versionList.first().toString() == "2.3.0"
        assert versionList.last().toString() == "2.4.0"
    }
...
c2d4ddcea3050857b048576a4bc9a14c50da7378 Tagging 2.1.6-SNAPSHOT for release"""
        ...
        assert versionList.first().toString() == "2.1.6"
        assert versionList.last().toString() == "3.3.0"
    }
}
